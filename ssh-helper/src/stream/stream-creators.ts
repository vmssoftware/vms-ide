...
import { MemoryReadStream, LogType, MemoryWriteStream, LogFunction } from "@vorfol/common";
...
export class MemoryStreamCreator implements IMemoryStreamCreator, ICanCreateReadStream, ICanCreateWriteStream {
    ...
    constructor(public chunks?: (Buffer | null)[], public emulateError?: boolean, public logFn?: LogFunction) {
    }
