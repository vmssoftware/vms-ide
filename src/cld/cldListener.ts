...
export interface cldListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by `cldParser.parameterValue`.
	 * @param ctx the parse tree
	 */
	enterParameterValue?: (ctx: ParameterValueContext) => void;
	/**
	 * Exit a parse tree produced by `cldParser.parameterValue`.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by `cldParser.qualifierValue`.
	 * @param ctx the parse tree
	 */
	enterQualifierValue?: (ctx: QualifierValueContext) => void;
	/**
	 * Exit a parse tree produced by `cldParser.qualifierValue`.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by `cldParser.keywordValue`.
	 * @param ctx the parse tree
	 */
	enterKeywordValue?: (ctx: KeywordValueContext) => void;
	/**
	 * Exit a parse tree produced by `cldParser.keywordValue`.
	 * @param ctx the parse tree
	 */
