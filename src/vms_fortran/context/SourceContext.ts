...
export class SourceContext 
{
    ...
    public getCodeCompletionCandidates(column: number, row: number): SymbolInfo[] 
    {
        ...
        core.ignoredTokens = new Set([
            ...
            FortranParser.COLON,
            FortranParser.ARROW,
            FortranParser.TO_ASSIGN,
            FortranParser.MINUS,
            FortranParser.PLUS,
            FortranParser.DIV,
            FortranParser.STAR,
            FortranParser.CONCAT,
            FortranParser.POWER,
            FortranParser.DOWN_LINE,
            FortranParser.EQUAL,
            FortranParser.NOT_EQUAL,
            FortranParser.MORE_,
            FortranParser.LESS,
            FortranParser.MORE_EQUAL,
            FortranParser.LESS_EQUAL,
            FortranParser.LNOT,
            FortranParser.LAND,
            FortranParser.LOR,
            FortranParser.EQV,
            ...
            FortranParser.FALSE,       
            FortranParser.SIGN,
            FortranParser.S_CONST,
            FortranParser.CONTN,
            FortranParser.CONT6,
            FortranParser.CONTTAB,
            FortranParser.EOS,
            FortranParser.DEBUG_COMMENT,
            FortranParser.WS,
            FortranParser.I_CONST,
            FortranParser.H_CONST,
            FortranParser.B_CONST,
            FortranParser.O_CONST,
            FortranParser.Z_CONST,
            FortranParser.P_CONST,
            FortranParser.X_CONST,
            FortranParser.F_CONST,
            FortranParser.IDENTIFIER,
            FortranParser.R_CONST,
            FortranParser.COMMENT,
            FortranParser.FIXED_COMMENT,
            FortranParser.SconSingle,
            FortranParser.SconDouble,
            FortranParser.EOF,
