...
export class ProjDepProvider implements vscode.TreeDataProvider<IProjectElement> {
    ...
    public static readonly cmdUploadDep = "vmssoftware.synchronizer.uploadDep";
    ...
    public prepareDebug(node: IProjectElement) {
        vscode.commands.executeCommand(ProjDepProvider.cmdPrepareDebug, this.selectedProject());
    }
    ...
    public uploadDep(node: IProjectElement) {
        vscode.commands.executeCommand(ProjDepProvider.cmdUploadDep, this.selectedProject());
    }
