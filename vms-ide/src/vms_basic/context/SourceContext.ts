...
import { BasicParser, ProgramContext } from "../parser/BasicParser";
import { BasicLexer } from "../parser/BasicLexer";
...
import { InFunctionSymbol, BuiltInTypeSymbol, ContextSymbolTable } from './ContextSymbolTable';
...
export class SourceContext 
{
    ...
    public setText(source: string) 
    {
        ...
        let lexer = new BasicLexer(input);
    ...
    public parse(): string[]
    {
        ...
        this.parser = new BasicParser(this.tokenStream);
    ...
    public getCodeCompletionCandidates(column: number, row: number): SymbolInfo[] 
    {
        ...
        core.ignoredTokens = new Set([
            ...
            BasicParser.CONCAT,
            BasicParser.POWER,
            BasicParser.DOWN_LINE,
            BasicParser.EQUAL,
            BasicParser.NOT_EQUAL,
            BasicParser.MORE_,
            BasicParser.LESS,
            BasicParser.MORE_EQUAL,
            BasicParser.LESS_EQUAL,
            BasicParser.EQV,
            BasicParser.XOR,
            BasicParser.GT,
            BasicParser.GE,
        ...
        core.preferredRules = new Set([
            // BasicParser.RULE_block,
            //BasicParser.RULE_procedureAndFunctionDeclarationPart
        ]);
        ...
        candidates.rules.forEach((callStack, key) => {
            switch (key) 
            {
                // case BasicParser.RULE_procedureAndFunctionDeclarationPart: 
                ...
                //     }                        
                //     break;
                // case BasicParser.RULE_identifier: 
