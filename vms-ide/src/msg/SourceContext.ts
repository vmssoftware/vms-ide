...
export class SourceContext {
    ...
    public getCodeCompletionCandidates(column: number, row: number): SymbolInfo[] {
        ...
        core.ignoredTokens = new Set([
            ...
            msgParser.COMMA,
            msgParser.EXCL,
            msgParser.ASTRING_OPEN,
            msgParser.QSTRING_OPEN,
            msgParser.BSTRING_OPEN,
            msgParser.ANY,
            msgParser.IDENTSEP,
            msgParser.IDENTNAME,
            msgParser.IDENTSTRING,
            msgParser.IDENTCOMMENT,
            msgParser.IDENT_CLOSE,
            msgParser.BSTRING_CLOSE,
            msgParser.BFAO,
            msgParser.BTEXT,
            msgParser.QSTRING_CLOSE,
            msgParser.QFAO,
            msgParser.QTEXT,
            msgParser.ASTRING_CLOSE,
            msgParser.AFAO,
            msgParser.ATEXT,
            msgParser.ANY,
            msgParser.EOF,
